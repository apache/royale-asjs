...
@java -Dsun.io.useCanonCaches=false -Xms32m -Xmx512m -Droyalecompiler="%FALCON_HOME%" -Droyalelib="%FLEX_HOME%\frameworks" -jar "%FALCON_HOME%\js\lib\compc.jar"  -sdk-js-lib="%FLEX_HOME%\frameworks\js\Royale\generated-sources" %*
