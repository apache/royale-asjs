...
@java -Dsun.io.useCanonCaches=false -Xms32m -Xmx512m -Droyalecompiler="%FALCON_HOME%" -Droyalelib="%FLEX_HOME%\frameworks" -jar "%FALCON_HOME%\js\lib\mxmlc.jar" -js-output-type=node +configname=node %*
