...
public interface IEffectInstance
{
	...
	/**
	 *  The event handler used by the effect 
	 *  
	 *  @langversion 3.0
	 *  @playerversion Flash 9
	 *  @playerversion AIR 1.1
	 ...
	 *  @private
	 */
	function set eventHandler(value:Function):void;
	 ...
	 *  @productversion Flex 3
	 */
	function get hideOnEffectEnd():Boolean;
	
	/**
	 *  @private
	 */
	function set hideOnEffectEnd(value:Boolean):void;
