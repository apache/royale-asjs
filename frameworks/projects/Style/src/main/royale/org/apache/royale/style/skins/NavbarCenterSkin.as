...
package org.apache.royale.style.skins
{
	...
	import org.apache.royale.style.NavbarCenter;
	...
	public class NavbarCenterSkin extends StyleSkin
	{
		public function NavbarCenterSkin()
		{
			super();
		}
		...
		{
			var nav:NavbarCenter = value as NavbarCenter;

			_styles = [
				new Display("flex"),
				new FlexShrink(0),
				new AlignItems("center"),
				new Gap(computeSize(16, nav.unit))
			];
