	...
	public class Icons 
	{
		...
		public static function help_medium():Icon{
			if (!Icon.isRegistered('support_icons_help_medium')) {
				Icon.registerIcon('support_icons_help_medium', <svg viewBox="0 0 20 20" fill="currentColor" stroke="none"><path d="M11 3a8 8 0 1 0 8 8a8 8 0 0 0-8-8zm1.3 12.3a1.222 1.222 0 0 1-.3.9a1.223 1.223 0 0 1-.9.3a1.2 1.2 0 0 1 0-2.4c.8 0 1.3.5 1.2 1.2zm.1-4.5c-.4.4-.8.8-.8 1.2a1.135 1.135 0 0 0 .3.8v.1a.098.098 0 0 1-.096.1H10.4a.229.229 0 0 1-.2-.1a1.666 1.666 0 0 1-.4-1.1a2.772 2.772 0 0 1 1-1.7a2.772 2.772 0 0 0 1-1.7c0-.5-.4-1.1-1.4-1.1a5.018 5.018 0 0 0-2 .4h-.2V6.3c0-.1 0-.2.1-.2a6.183 6.183 0 0 1 2.4-.5c1.9 0 3.1 1.1 3.1 2.7a3.704 3.704 0 0 1-1.4 2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>);
			}
