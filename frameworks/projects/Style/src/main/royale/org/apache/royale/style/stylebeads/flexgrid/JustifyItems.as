...
package org.apache.royale.style.stylebeads.flexgrid
{
	...
	public class JustifyItems extends LeafStyleBase
	{
		public function JustifyItems(value:* = null)
		{
			super("justify-items", "justify-items", value);
		}
		...
		{
			assert(["start","end","safe end","end safe","center","safe center","center safe","stretch","normal"].indexOf(value) >= 0, "Invalid value for justify-items: " + value);
			_value = value;
