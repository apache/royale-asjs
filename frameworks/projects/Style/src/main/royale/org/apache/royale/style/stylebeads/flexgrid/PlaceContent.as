...
package org.apache.royale.style.stylebeads.flexgrid
{
	...
	public class PlaceContent extends LeafStyleBase
	{
		...
		{
			assert(["center","center safe","safe center","start","end","end safe","safe end","space-between","space-around","space-evenly","baseline","stretch"].indexOf(value) >= 0, "Invalid value for place-content: " + value);
			_value = value;
