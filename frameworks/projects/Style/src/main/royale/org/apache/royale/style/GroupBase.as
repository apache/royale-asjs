...
package org.apache.royale.style
{
	...
	public class GroupBase extends StyleUIBase implements IStatesObject, IContainer, ILayoutParent, ILayoutView, IContentViewHost
	{
		...
		/**
		 * This exists only to complete the signature for IStatesObject.
		 * Any transitions will be handled by CSS classes in Style.
		 */
		public function get transitions():Array
		{
			trace("Warning: Transitions are not currently supported in Style components. Use CSS transitions instead.");
			return null;
		}
