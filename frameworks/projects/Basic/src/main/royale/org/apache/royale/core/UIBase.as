...
package org.apache.royale.core
{
	...
	public class UIBase extends HTMLElementWrapper implements IStrandWithModelView, IEventDispatcher, IParentIUIBase, IStyleableObject, ILayoutChild, IRoyaleElement, IId
	{
		...
		public function get parentApplication():Object
		{
			...
			// If this UIBase is its own root, then it is an Application.
			...
			if (o == this)
			{
				var p:UIBase = o.systemManagerBasic.parent as UIBase;
				o = p ? p.systemManagerBasic.mxmlDocument : null;
			}
		...
		{
			// TODO
			if (_systemManager == null && parent != null && parent is UIBase)
				_systemManager = (parent as UIBase).systemManagerBasic;
		 ...
		 *  @private
		 */
		public function set systemManagerBasic(value:ISystemManager):void
		{
			// TODO
		...
		public function set mxmlDocument(value:Object):void
		{
			...
			{
				var child:IUIBase = getChildAtBasic(i) as IUIBase;
				if (!child)
					continue;
				...
				if (child.mxmlDocument == _mxmlDocument ||
					...
					child.mxmlDocument == topLevelApplication)
				{
