    ...
    protected function faultHandler(msg:ErrorMessage):void
    {
        if (msg != null)
        {
            ...
            else
            {
                ...
                if (RoyaleClient.getInstance().id == null && msg.headers != null && msg.headers[AbstractMessage.FLEX_CLIENT_ID_HEADER] != null)
                ...
                if (msg.headers != null && msg.headers[CommandMessage.MESSAGING_VERSION] != null)
                {
