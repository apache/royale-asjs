...
package mx.controls.beads.layouts
{
	 ...
	 */
	public class DataGridListVerticalLayout extends LayoutBase implements IBeadLayout
	{
		/**
		 *  Constructor.
		 *
		 ...
		 *  @productversion Royale 0.0
		 */
		public function DataGridListVerticalLayout()
		{
			super();
		}
		...
		override public function layout():Boolean
		{
			...
			COMPILE::JS
			{
				...
				var parentWidth:uint = contentView.element.clientWidth;
				children = contentView.internalChildren();
				n = children.length;
				for (i = 0; i < n; i++)
				{
					var childElement:WrappedHTMLElement = children[i] as WrappedHTMLElement;
					var child:UIBase = childElement.royale_wrapper as UIBase;
					if (child == null) continue;
					if(!child.displayStyleForLayout)
					{
						if (!child.visible)
						{
