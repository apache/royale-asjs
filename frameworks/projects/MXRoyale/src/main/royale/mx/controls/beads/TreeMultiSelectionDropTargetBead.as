...
package mx.controls.beads 
{
	...
	/**
	 *  The TreeMultiSelectionDropTargetBead enables items to be dropped onto multi-selection Tree
	 *  components. This bead can be used with MultiSelectionDragSourceBead to enable the re-arrangement
	 ...
	 */
	public class TreeMultiSelectionDropTargetBead extends EventDispatcher implements IBead
	{
		/**
		 * Constructor
	     *
		...
		{
			//trace("TreeMultiSelectionDropTargetBead received DragEnter via: "+event.relatedObject.toString());
		...
		{
			//trace("TreeMultiSelectionDropTargetBead received DragExit via: "+event.relatedObject.toString());
		...
		{
			//trace("TreeMultiSelectionDropTargetBead received DragOver via: "+event.relatedObject.toString());
		...
		{
			//trace("TreeMultiSelectionDropTargetBead received DragDrop via: "+event.relatedObject.toString());
			...
			if (dataProviderModel is IMultiSelectionModel) {
				(dataProviderModel as IMultiSelectionModel).selectedItems = dragSource as Array;
			}
