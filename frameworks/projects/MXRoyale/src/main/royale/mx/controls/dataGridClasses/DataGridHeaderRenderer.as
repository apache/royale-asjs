...
import mx.controls.dataGridClasses.DataGridButtonBar;
 ...
 *  @productversion Flex 3
 */
public class DataGridHeaderRenderer extends UIComponent implements IDataRenderer,
      ...
      
{
   // include "../../core/Version.as";
    ...
    public function DataGridHeaderRenderer()
    {
        ...
        typeNames = "DataGridHeaderRenderer";
   ...
   // private var grid:AdvancedDataGrid;
    ...
    public function set data(value:Object):void
    {
        ...
        var ld:DataGridListData = new DataGridListData(getColumnLabel(col),
                col.dataField, 
...
//                 label.wordWrap = grid.columnHeaderWordWrap(grid.columns[listData.columnIndex]);
    ...
    /*protected function processVariations(dataGrid:ListBase):void{
