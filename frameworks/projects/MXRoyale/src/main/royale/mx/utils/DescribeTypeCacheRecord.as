...
package mx.utils 
{
	...
	COMPILE::JS {
		...
		import mx.utils.flash_proxy;
		use namespace mx.utils.flash_proxy;
	}
	...
	public dynamic class DescribeTypeCacheRecord extends Proxy
	{
		 ...
		 */
		COMPILE::SWF
		override flash.utils.flash_proxy function getProperty(name:*):*
		{
		 ...
		 */
		COMPILE::SWF
		override flash.utils.flash_proxy function hasProperty(name:*):Boolean
		{
			if (name in cache)
				return true;
