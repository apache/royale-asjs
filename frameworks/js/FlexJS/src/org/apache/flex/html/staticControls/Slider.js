 ...
 */
org.apache.flex.html.staticControls.Slider.prototype.addToParent = function(p) {
  ...
  //goog.events.listen(this.track, 'click', goog.bind(this.handleTrackClick, this));
  goog.events.listen(this.track, goog.events.EventType.CLICK, this.handleTrackClick, false, this);
  ...
  goog.events.listen(this.thumb, goog.events.EventType.MOUSEDOWN, this.handleThumbDown, false, this);
 ...
 */
org.apache.flex.html.staticControls.Slider.prototype.set_value = function(newValue) {
 ...
 */
org.apache.flex.html.staticControls.Slider.prototype.set_minimum = function(value) {
 ...
 */
org.apache.flex.html.staticControls.Slider.prototype.get_maximum = function() {
 ...
 */
org.apache.flex.html.staticControls.Slider.prototype.set_maximum = function(value) {
 ...
 */
org.apache.flex.html.staticControls.Slider.prototype.get_snapInterval = function() {
 ...
 */
org.apache.flex.html.staticControls.Slider.prototype.set_snapInterval = function(value) {
 ...
 */
org.apache.flex.html.staticControls.Slider.prototype.handleTrackClick = function(event)
{
  ...
  this.calculateValueFromMousePosition(event,true);
};
 ...
 */
org.apache.flex.html.staticControls.Slider.prototype.handleThumbDown = function(event)
{
  goog.events.listen(this.element, goog.events.EventType.MOUSEUP, this.handleThumbUp, false, this);
  goog.events.listen(this.element, goog.events.EventType.MOUSEMOVE, this.handleThumbMove, false, this);
 ...
 */
org.apache.flex.html.staticControls.Slider.prototype.handleThumbUp = function(event)
{
  goog.events.unlisten(this.element, goog.events.EventType.MOUSEUP, this.handleThumbUp, false, this);
  goog.events.unlisten(this.element, goog.events.EventType.MOUSEMOVE, this.handleThumbMove, false, this);
  
  this.calculateValueFromMousePosition(event,false);
};
 ...
 */
org.apache.flex.html.staticControls.Slider.prototype.handleThumbMove = function(event)
{
  this.calculateValueFromMousePosition(event,false);
}
...
/**
 * @this {org.apache.flex.html.staticControls.Slider}
 * @return {void} Determines the new value based on the movement of the mouse along the slider
 */
org.apache.flex.html.staticControls.Slider.prototype.calculateValueFromMousePosition = function(event,useOffset)
{
  ...
  this.thumb.style.left = String(newX - parseInt(this.thumb.style.width,10)/2) + "px";
