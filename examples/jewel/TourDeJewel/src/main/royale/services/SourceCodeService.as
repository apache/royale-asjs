...
package services
{
    ...
    /**
     * SourceCodeService is in charge of getting the source code of some example
     * so we can show the code in a TabBarContentPanel along with the working example
     */
	public class SourceCodeService extends EventDispatcher
	{
        /**
         * constructor
         */
        public function SourceCodeService():void
        {    
